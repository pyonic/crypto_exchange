...
import { ConvertQuery, CurrencyExchange } from 'src/models/currencies.interface';
...
export class CurrencyController {
  ...
  async currencyExchange(
    ...
    })) data: ConvertQuery): Promise<ConvertQuery> {

      const exchange: CurrencyExchange = await this.currencyService.exchangeCurrency(data);
